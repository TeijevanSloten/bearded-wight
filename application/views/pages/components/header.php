            ...
            <div class="col-md-7" style="margin-top: 14px;">
                ...
                <div style="margin-top: 20px;">
                    <ul class="nav nav-tabs pull-right">
                        <li role="presentation"<?php echo ($page == "home" ? ' class="active"' : ''); ?>><a href="index.php">Home</a></li>
                        <li role="presentation"<?php echo ($page == "relic" ? ' class="active"' : ''); ?>><a href="relic.php">Memory Light Relic</a></li>
                        <li role="presentation"<?php echo ($page == "dispenser" ? ' class="active"' : ''); ?>><a href="dispenser.php">Memory Candle Dispenser</a></li>
                        <li role="presentation"<?php echo ($page == "contact" ? ' class="active"' : ''); ?>><a href="contact.php">Partner Program</a></li>
                    </ul>
                </div>
            </div>
        </div>
