                    ...
                    <div class="col-md-7" style="margin-top: 14px;">
                        ...
                        <div style="margin-top: 20px;">
                            <ul class="nav nav-tabs pull-right">
                                ...
                                <li role="presentation" class="active"><a href="dispenser.php">Memory Candle Dispenser</a></li>
...
<!--                        <ul class="col-md-6 list-group standard-text">
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <p>
                            ...
                            Sometimes words aren't enough to help.<br>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-center"><a href="privacy.php" class="footer-link">privacy policy</a> - made by mdtvs</p>
                    </div>
                </div>
            </div>
        </footer>
